...
R3 routerın DR olmasını istiyor isek, iki seçeneğimiz var.

- R3 routerın Router-id büyük olduğu için DR routerda "clear ip ospf process" çalıştırabiliriz.
...
- DR eşleştirmesinde önce priortye bakar eşit ise router-id'ye bakar.
...
Bir önceki seq number ile gönderilen paketin reply paketi geldi ve flag 0x0 şeklinde geldi. Akabinde pazarlık tamamlandı ve R3 master oldu.  
flag 0x7 master  
flag 0x0 slave 

<img width="771" height="45" alt="image" src="https://github.com/user-attachments/assets/0c0bb6e5-e9af-4ee2-bee9-139beac92c2c" />

MTU defaulta 1500 dür. Eğer eşleşmez ise komşuluk EXSTART da kalır. Komşuluk kurulmaz.

## EXCHANGE State

Artık LSA paketlerinin gönderimi ve rota bilgileri alınarak opsf areasındaki tüm rotalar öğrenilmeye başlanır.  
<img width="751" height="137" alt="image" src="https://github.com/user-attachments/assets/4a4f75fa-eff8-48e0-a201-a4f2cb79faf6" />  


Komşusuna gönderecek 4 adet LSA  bilgisini hazırladı.    
<img width="380" height="21" alt="image" src="https://github.com/user-attachments/assets/577a715f-1e9c-4904-840a-f7b7eec7da3b" />  


Hazırladığı 4 adet LSA  özet bilgileri içeren DBD paketini komşusuna gönderdi.   
<img width="557" height="24" alt="image" src="https://github.com/user-attachments/assets/1669129b-0fa2-457f-bc92-8dff8989130c" />  


Komşu router yani R1 R3'ün gönderdiği özet bilgileirin tam bilgisini ister. O yüzden LS REQ (request) paketi gönderir.   
<img width="441" height="21" alt="image" src="https://github.com/user-attachments/assets/cfee3ebc-a075-4276-a8c4-a4c5c4733c27" />    


R3 gelen request paketine karşılık update paketi gönderir.   
<img width="472" height="24" alt="image" src="https://github.com/user-attachments/assets/f9f445de-e46f-4a38-9eb6-1dec85a7c039" />  


R1 update paketini aldıktan sonra database günceller ve onay mesajı içeren DBD paketini gönderir. Bu DBD paketinin seq numberı R3'ün gönderdiği seq number ile aynıdır.  
<img width="761" height="24" alt="image" src="https://github.com/user-attachments/assets/0d12b3c7-d277-49ee-b4fb-a1d1a284c091" />  


Bu şekilde EXCHANGE state tamamlanmış olur.  
<img width="262" height="22" alt="image" src="https://github.com/user-attachments/assets/c5e9e2ef-bf92-4c2a-9266-dea913f64985" />  
